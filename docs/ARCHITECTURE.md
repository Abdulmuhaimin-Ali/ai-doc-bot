...
graph LR
    ...
    class API,BusinessLogic,DataAccess backend
    class API API Layer (Express.js)
    class BusinessLogic Business Logic Layer
    class DataAccess Data Access Layer (Prisma)
```
